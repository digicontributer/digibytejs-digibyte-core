 ...
 */
typedef boost::variant<CNoDestination, CKeyID, CScriptID, WitnessV0ScriptHash, WitnessV0KeyHash, WitnessUnknown, CKeyID256, CScriptID256> CTxDestination;
...
/**
 * Generate a DigiByte scriptPubKey for the given CTxDestination. Returns a P2PKH
