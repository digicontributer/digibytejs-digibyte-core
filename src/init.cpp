...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/digibyte-project/digibyte>";
    const std::string URL_WEBSITE = "<https://digibyte.org>";
