    ...
    tab(tab)
{
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your DigiByte addresses for sending payments. Always check the amount and the receiving address before sending coins."));
