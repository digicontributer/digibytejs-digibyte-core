...
Note
---------------------
Always use absolute paths to configure and compile digibyte and the dependencies,
...
# Pick some path to install BDB to, here we create a directory within the digibyte directory
BDB_PREFIX="${DIGIBYTE_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure DigiByte Core to use our own-built instance of BDB
cd $DIGIBYTE_ROOT
./autogen.sh
