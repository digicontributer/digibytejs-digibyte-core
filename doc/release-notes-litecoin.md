DigiByte Core version 0.13.3 is now available from:

  <https://download.digibyte.org/digibyte-0.13.3/>
...
DigiByte Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
